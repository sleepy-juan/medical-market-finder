...
export const HyMarketsize = {
  encode(message: HyMarketsize, writer: Writer = Writer.create()): Writer {
    if (message.index !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): HyMarketsize {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseHyMarketsize } as HyMarketsize;
  ...
  fromJSON(object: any): HyMarketsize {
    const message = { ...baseHyMarketsize } as HyMarketsize;
  ...
  toJSON(message: HyMarketsize): unknown {
    const obj: any = {};
  ...
  fromPartial(object: DeepPartial<HyMarketsize>): HyMarketsize {
    const message = { ...baseHyMarketsize } as HyMarketsize;
    if (object.index !== undefined && object.index !== null) {
