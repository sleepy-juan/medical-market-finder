...
import (
	...
	khidimodule "khidi/x/khidi"
	khidimodulekeeper "khidi/x/khidi/keeper"
	khidimoduletypes "khidi/x/khidi/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "khidi"
	Name                 = "khidi"
)
...
type App struct {
	*baseapp.BaseApp
	...
	KhidiKeeper khidimodulekeeper.Keeper
...
func New(
	...
	app.KhidiKeeper = *khidimodulekeeper.NewKeeper(
		appCodec,
		keys[khidimoduletypes.StoreKey],
		keys[khidimoduletypes.MemStoreKey],
		app.GetSubspace(khidimoduletypes.ModuleName),
	)
	khidiModule := khidimodule.NewAppModule(appCodec, app.KhidiKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(khidimoduletypes.ModuleName)
