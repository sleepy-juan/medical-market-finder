...
function makeReport(country1,country2,hyScores){
    ...
    if(protectionism1>protectionism2){
        report2['낮은 보호주의']=country2+"은(는)" +export2/10+"만달러를 수출하고,"+import2/10+"만달러를 수입하고 있습니다. 큰 수출규모를 달성할 기술이 있고, 내수점유율을 높일 수 있다고 판단되지만 여전히 시장규모 대비 많은 양을 수입하고 있어 보호주의가 낮은 비교적 자유로운 시장으로 분석됩니다."
    }
    else{
        report1['낮은 보호주의']=country1+"은(는)" +export1/10+"만달러를 수출하고,"+import1/10+"만달러를 수입하고 있습니다. 큰 수출규모를 달성할 기술이 있고, 내수점유율을 높일 수 있다고 판단되지만 여전히 시장규모 대비 많은 양을 수입하고 있어 보호주의가 낮은 비교적 자유로운 시장으로 분석됩니다."
    }
