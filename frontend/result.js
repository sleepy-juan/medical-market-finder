...
const pieArea1 = document.getElementById('pie1').getContext('2d');
...
const pieArea2 = document.getElementById('pie2').getContext('2d');
const pie2 = new Chart(pieArea2, {
    type: 'polarArea',
    data: {
        labels: ['Red', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange'],
        datasets: [{
